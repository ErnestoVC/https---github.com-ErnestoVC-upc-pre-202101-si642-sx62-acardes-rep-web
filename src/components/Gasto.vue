    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('api/Gasto/Listar',configuracion).then(function(response){
            ...
            guardar(){
                ...
                if (this.editedIndex > -1) {
                    let me = this;
                    axios.put('api/Gasto/Actualizar',{
                        'idgasto': me.id,
                        'codigo': me.codigo,
                        'nombre': me.nombre,
            ...
            activar(){
                ...
                let header={"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion= {headers : header};
                axios.put('api/Gasto/Activar/'+this.adId,{},configuracion).then(function(response){
                    me.adModal = 0;
                    me.adAccion = 0;
                    me.adNombre = "";
                    me.adId = "";
            ...
            desactivar(){
               let me=this;
                let header={"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion= {headers : header};
                axios.put('api/Gasto/Desactivar/'+this.adId,{},configuracion).then(function(response){
                    me.adModal = 0;
                    me.adAccion = 0;
                    me.adNombre = "";
                    me.adId = "";
